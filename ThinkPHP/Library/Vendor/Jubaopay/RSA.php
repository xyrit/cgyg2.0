...
class RSA
{
	...
	public function __construct($conf)
	{
		...
		$this->_privFile = VENDOR_PATH.$items->item(0)->getElementsByTagName('pfx')->item(0)->nodeValue;
		$this->_pubFile = VENDOR_PATH.$items->item(0)->getElementsByTagName('cer')->item(0)->nodeValue;
